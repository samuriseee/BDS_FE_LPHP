      ...
      <div class="create-post">
        ...
        <div class="realEstate info">
          ...
          <div class="price">
            ...
            >
              <label for="title">Giấy tờ pháp lý</label>
              <el-select
                v-model="newEstatePost.GiayToPhapLy"
                filterable
                allow-create
...
export default {
  ...
  methods: {
    ...
    async getPostById() {
      this.loading = true;
      const response = await RealEstateService.getPostById(this.routerId);
      const mappedEstate = {
        ...response,
        bat_dong_san: {
